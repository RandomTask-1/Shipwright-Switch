...
You can use the Windows Subsystem for Linux (WSL) to build.

* Microsoft Reference:  https://learn.microsoft.com/en-us/windows/wsl/install
...
Open Ubuntu from the start menu or terminal
